...
- Я так и не смог настроить человеческий доступ к веткам так, чтобы кто-то кроме меня в них мог нормально загрузить изменения, поэтому все изменения вам придётся отсылать мне лично, а мне придётся их вручную отсылать на Github
